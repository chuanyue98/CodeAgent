...
CodeAgent is a professional, CLI-first AI orchestration framework. It acts as an **engineering shell** that delivers your private standards (The "Soul") and automation tools (The "Skills") to any LLM engine, ensuring consistent, high-quality engineering output.
...
- **Cross-Engine Delegation & MCP** — Built-in FastMCP server turns CodeAgent into a multi-engine hub where models dynamically delegate subtasks and hand off sessions
